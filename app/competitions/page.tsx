        ...
        <div className="page-container">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground">
              Hackathons, contests, and competitive programming achievements
            </p>
          </div>
                                  ...
                                  <span key={idx}>
                                    {member.linkedin ? (
                                      <a
                                        ...
                                        className="relative z-10 text-sm text-muted-foreground hover:text-foreground transition-colors duration-200"
